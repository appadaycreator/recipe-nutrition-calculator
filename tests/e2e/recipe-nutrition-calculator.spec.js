...
const SVC_URL = "https://appadaycreator.com/recipe-nutrition-calculator/";
const SVC_NAME = "レシピ栄養計算ツール";

test.describe("レシピ栄養計算ツール - E2Eテスト", () => {
  ...
  test("ページ基本: タイトル・h1・canonical", async ({ page }) => {
    ...
    expect(canonical).toContain("recipe-nutrition-calculator");
